 ...
 * @author guilh
 */
public class BookCoins extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookCoins.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
